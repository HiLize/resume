...
module.exports = {
     ...
     output:{
          ...
          path:path.resolve(__dirname,'doc'), //输出位置
...
　　　　inline: true,              //实时刷新
        // 设置服务器访问的基本目录
        contentBase:path.resolve(__dirname,'doc'), //指定服务开启的位置，在doc文件夹中,该路径==='./doc'
    ...
    plugins:[
        ...
        new HtmlWebpackPlugin({
          template: __dirname + '/src/index.html'  //默认会在doc路径下生成index.html并引用所有的静态资源
        })
    ]
}